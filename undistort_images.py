...
# img_names_undistort = ["calibrate_dir/img1.png", "calibrate_dir/img2.png", "calibrate_dir/img3.png", "calibrate_dir/img4.png"]
# img_names_undistort = ["calibrate_dir/frame_422.png"]
...
for img_found in img_names_undistort:
    ...
    name = img_found[7:]
    full_name = new_path + name.replace('.png','') + '.jpg'
